...
# Compute <b_i b_j> for the memory constrained walker
# to do this it will compute <cos deltatheta> on an ensemble, and will measure for different alpha.
# once compute the cosine it's possible to look at the correlation function and compute the persistence length
# The program perform some fit in the end and can do a grid measure over sigma and memory_tau

#This proggram is part of the Netgrowth project and SeNec Initiative.
